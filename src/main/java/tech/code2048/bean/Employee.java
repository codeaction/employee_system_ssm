...
public class Employee {
    ...
    public Employee(Long eid, String eno, String ename, Integer eage, String egender, String ejob, Date eentrydate, BigDecimal esalary, Integer estate, Integer did) {
        this.eid = eid;
        this.eno = eno;
        this.ename = ename;
        this.eage = eage;
